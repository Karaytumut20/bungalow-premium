...
const targetPath = fs.existsSync(path.join(process.cwd(), "package.json"))
  ? process.cwd()
  : path.join(process.cwd(), "bungalow-premium");

console.log("🛠️ ADIM 11: Next.js 15+ Async Params Hatası Düzeltiliyor...\n");

// 1. Detay Sayfasını (bungalov/[id]/page.tsx) Güncelle
const detailPagePath = path.join(targetPath, "src/app/bungalov/[id]/page.tsx");

const fixedDetailContent = `import Image from "next/image";
import { notFound } from "next/navigation";
import { MapPin, Star, Wind, Coffee, Car, Wifi, Waves, Flame, Users, ChevronLeft } from "lucide-react";
...
fs.writeFileSync(detailPagePath, fixedDetailContent);

console.log("✅ Hata başarıyla düzeltildi: params artık await ediliyor.");
console.log("🚀 Sayfayı yenilediğinde detayların kusursuz gelmesi gerekiyor.");
